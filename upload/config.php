<?php
// HTTP
define('HTTP_SERVER', 'http://localhost:8080/electrozone/upload/');

// HTTPS
define('HTTPS_SERVER', 'http://localhost:8080/electrozone/upload/');

// DIR
define('DIR_APPLICATION', '/opt/lampp/htdocs/electrozone/upload/catalog/');
